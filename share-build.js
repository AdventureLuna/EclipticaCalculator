(function (root, factory) {
  ...
  function encodeBuild(build) {
    ...
    if (version !== FORMAT_VERSION) throw new Error(`Unsupported build format version: ${version}`);
    return encodeBuildV1(build);
  }
  ...
  function decodeBuildV1(reader) {
    ...
    return { version: FORMAT_VERSION, characterId, upgrades };
  }
  ...
  return {
    FORMAT_VERSION, VERSION_BITS, CHARACTER_ID_BITS, ENTRY_COUNT_BITS, UPGRADE_ID_BITS,
    BitWriter, BitReader, encodeBuildV1, decodeBuildV1, encodeBuild, decodeBuild,
